...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .ticket { width: 148mm; height: 104mm; display: flex; overflow: hidden; border: 1px solid #d1d5db; page-break-after: avoid; }
        .color-strip { width: 8px; flex-shrink: 0; background: {{ $category?->badge_color ?? '#1a56db' }}; }
        .main { position: relative; flex: 1; display: flex; flex-direction: column; padding: 12mm 10mm 8mm 10mm; }
        ...
        .qr-section { position: absolute; top: 31mm; right: 10mm; width: 34mm; height: 34mm; }
        .qr-section img { display: block; width: 34mm; height: 34mm; }
    ...
    <div class="ticket">
        ...
        <div class="main">
            ...
            <div class="footer">
                ...
                <span>Present this QR at the entrance</span>
            </div>
        </div>
    </div>
</body>
